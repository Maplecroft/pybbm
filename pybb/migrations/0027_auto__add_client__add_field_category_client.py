...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Client'
        db.create_table('pybb_client', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('pybb', ['Client'])

        # Adding field 'Category.client'
        db.add_column('pybb_category', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'client_forums', to=orm['pybb.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Client'
        db.delete_table('pybb_client')

        # Deleting field 'Category.client'
        db.delete_column('pybb_category', 'client_id')
    ...
    models = {
        ...
        'pybb.attachment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'attachments'", 'to': "orm['pybb.Post']"}),
            'size': ('django.db.models.fields.IntegerField', [], {})
        },
        'pybb.category': {
            'Meta': {'ordering': "[u'position']", 'object_name': 'Category'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'client_forums'", 'to': "orm['pybb.Client']"}),
        ...
        'pybb.client': {
            'Meta': {'ordering': "[u'name']", 'object_name': 'Client'},
        ...
        'pybb.forum': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'forums'", 'to': "orm['pybb.Category']"}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'child_forums'", 'null': 'True', 'to': "orm['pybb.Forum']"}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'post_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'readed_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'readed_forums'", 'symmetrical': 'False', 'through': "orm['pybb.ForumReadTracker']", 'to': "orm['auth.User']"}),
        ...
        'pybb.pollanswer': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'poll_answers'", 'to': "orm['pybb.Topic']"})
        },
        'pybb.pollansweruser': {
            'Meta': {'unique_together': "((u'poll_answer', u'user'),)", 'object_name': 'PollAnswerUser'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poll_answer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'users'", 'to': "orm['pybb.PollAnswer']"}),
        ...
        'pybb.post': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'posts'", 'to': "orm['pybb.Topic']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'pybb.topic': {
            ...
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'topics'", 'to': "orm['pybb.Forum']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'post_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'readed_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'readed_topics'", 'symmetrical': 'False', 'through': "orm['pybb.TopicReadTracker']", 'to': "orm['auth.User']"}),
